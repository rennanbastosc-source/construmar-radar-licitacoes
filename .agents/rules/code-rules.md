...
| -------------------------------------- | --------------------- | --------------------------------------------- |
| **MOBILE** (iOS, Android, RN, Flutter) | `mobile-developer`    | mobile-design, strict-guardrails              |
| **WEB** (Next.js, React web)           | `frontend-specialist` | frontend-design, strict-guardrails            |
| **BACKEND** (API, server, DB)          | `backend-specialist`  | api-patterns, database-design, strict-guardrails |

> 🔴 **Mandatory Quality Gate:** For any code change or refactoring, always load and apply `@[strict-guardrails]`.
