...
model: inherit
version: 1.0.0
skills: strict-guardrails, clean-code, design-spec, nextjs-react-expert, frontend-architecture, web-design-guidelines, tailwind-patterns, frontend-design, lint-and-validate
---
